...
#define TRIG_PIN 35
#define ECHO_PIN 37
// #define OBSTACLE_PIN 51 // VM330 output, unused

Servo servoLook;
// volatile bool obstacleDetected = false;  // no longer used
...
void setup() {
  ...
  // Attach hardware interrupts (Mega: 2–5, pins 18 - 21)
  ...
  // Obstacle sensor (VMA330) removed
